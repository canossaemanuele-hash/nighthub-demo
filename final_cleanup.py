...
# Replace the entire block from the first 'function renderSerate'
# until the 'async function creaNuovaSerata' to remove duplicates and syntax errors.

pattern = r'function renderSerate\(serate\) \{.*?async function creaNuovaSerata\(\)'
replacement = """function renderSerate(serate) {
